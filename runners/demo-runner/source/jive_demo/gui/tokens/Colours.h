...
namespace jive_demo::colours
{
    ...
    static const auto red600 = jive::parseColour("#C93C37");

    static const auto blue400 = jive::parseColour("#4184E4");
    static const auto blue500 = jive::parseColour("#316DCA");
    static const auto blue600 = jive::parseColour("#255AB2");
    static const auto blue700 = jive::parseColour("#1B4B91");
} // namespace jive_demo::colours
